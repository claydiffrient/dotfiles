...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Charles Clayton}{Diffrient}
\address{8261 S Romaine Drive, Sandy, UT 84070}
\mobile{(208) 206-9691}
%%% Social
\email{clay.diffrient@gmail.com}
\homepage{https://clayd.dev}
\github{claydiffrient}
\linkedin{claydiffrient}
%%% Optionals
\position{Software Engineer{\enskip\cdotp\enskip}Education Enthusiast}
